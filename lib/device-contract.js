...
class DeviceContract extends Contract {
    ...
    */
     ...
     */
    async instantiate(ctx, arg1, arg2) {
    ...
    */
    async issue(ctx, attributesHash, identityFlag) {
        ...
        let ownerBlockchainAddress = ctx.stub.getCreator();
        console.log(ownerBlockchainAddress);
