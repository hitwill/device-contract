...
class DeviceContract extends Contract {
    ...
    */
    async issue(ctx, deviceBlockchainAddress, ownerBlockchainAddress, attributesHash, identityFlag) {
        let firstBlockNumber = await ctx.stub.getTxID();
        ...
        //TODO: move logic of setting blocknumbers to device-list.js so it's implicit
        device.setFirstBlockNumber(firstBlockNumber);
